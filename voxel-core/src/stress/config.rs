...
impl Default for StressConfig {
    fn default() -> Self {
        Self {
            ...
            mining_stress_scan_buffer: 4, // 22 -> 7 (2026-07-31), 7 -> 4 (2026-08-22: total scan
                                          // radius cut 35%, 2.2+7=9.2 -> ~6.0 voxels at r=65 UU /
                                          // WorldScale 30); configurable since 2026-05
        }
    }
}
