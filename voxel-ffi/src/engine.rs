...
pub fn ffi_config_to_sleep(c: &FfiEngineConfig) -> voxel_sleep::SleepConfig {
    ...
    voxel_sleep::SleepConfig {
        ...
        veins: VeinConfig {
            ...
            vein_climb_height_min: if c.sleep_vein_climb_height_min > 0 { c.sleep_vein_climb_height_min } else { 6 },
            vein_climb_height_max: if c.sleep_vein_climb_height_max > 0 { c.sleep_vein_climb_height_max } else { 12 },
            vein_wall_width_min: if c.sleep_vein_wall_width_min > 0 { c.sleep_vein_wall_width_min } else { 2 },
            vein_wall_width_max: if c.sleep_vein_wall_width_max > 0 { c.sleep_vein_wall_width_max } else { 3 },
            vein_rock_depth_min: if c.sleep_vein_rock_depth_min > 0 { c.sleep_vein_rock_depth_min } else { 1 },
            vein_rock_depth_max: if c.sleep_vein_rock_depth_max > 0 { c.sleep_vein_rock_depth_max } else { 3 },
