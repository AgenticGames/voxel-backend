...
mod tests {
    ...
    fn test_config() -> FfiEngineConfig {
        FfiEngineConfig {
            ...
            formation_drapery_wave_amplitude: 0.8,
            formation_rimstone_chance: 0.04,
            formation_rimstone_dam_height_min: 1.0,
            formation_rimstone_dam_height_max: 2.0,
            formation_rimstone_pool_depth: 1.0,
            formation_rimstone_min_slope: 0.15,
            formation_shield_chance: 0.03,
            formation_shield_radius_min: 3.0,
            formation_shield_radius_max: 6.0,
